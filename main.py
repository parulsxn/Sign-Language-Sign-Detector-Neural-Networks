...
X_train, X_test, y_train, y_test = train_test_split(X_train,y_train,random_state=2, test_size = 20, stratify = y_train)
...
print("\nThese accuracies are much better compared to the inital accuracies of 22.3% and 18.5% respectively.")
print("\n---------")

#create confusion matrix
conf_matrix = confusion_matrix(y_test, y_pred)
class_ids = sorted(total_counts.keys())
# print("\nclass ids are : " + str(class_ids))
...
# a = 0 and so on until (skipping j) k = 10

# print("\nBased on the confusion matrix above, the program commonly misidentifies class 5 as class 1, class one as class 3, class 8 as class 4")

print("\nBased on the confusion matrix above, the program commonly misidentifies f and b, b and d, i and e with each other. ")